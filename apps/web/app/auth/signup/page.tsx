    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--bg)]">
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-[var(--brand)] mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">
                사업자명 <span className="text-[var(--danger)]">*</span>
              </label>
              <input
                type="text"
                value={businessName}
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">
                사업자 등록 번호 <span className="text-[var(--danger)]">*</span>
              </label>
              <input
                type="text"
                value={businessRegNo}
