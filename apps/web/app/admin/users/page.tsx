          ...
          {loading ? (
            ...
            <div className="card overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {users.map((user) => (
                    <tr key={user.id} className="border-b border-[var(--border-light)]">
                        ...
                        {user.status === 'PENDING' && (
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="text-xs px-3 py-1 rounded border border-[var(--border)] hover:bg-[var(--border-light)] disabled:opacity-50"
