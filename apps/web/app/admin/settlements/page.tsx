...
export default function AdminSettlementsPage() {
  ...
  const loadAgencies = async (q?: string, autoSelectFirst?: boolean) => {
    ...
    try {
      ...
      const list = (Array.isArray(data) ? data : data?.items || []) as AgencyListRow[];
      setAgencies(list);
            ...
            <div className="card space-y-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="px-3 py-2 rounded bg-[var(--bg)] w-full"
                  ...
                  {agencies.map((a) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded border border-[var(--border)] hover:bg-[var(--bg)] ${
                ...
                <>
                  <div className="card space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <div className="flex items-center justify-between gap-3 border border-[var(--border)] rounded px-3 py-2">
                        <div className="text-sm" style={{ color: 'var(--muted)' }}>
                          마지막 충전일
                        </div>
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            {agencySettlement.details.map((d) => (
                              <tr key={d.id} className="border-b border-[var(--border-light)]">
