          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="text-xs px-3 py-1 rounded border border-[var(--border)] hover:bg-[var(--border-light)]"
            ...
            <>
              ...
              {agency.status === 'PENDING' ? (
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    className="text-sm px-4 py-2 rounded border border-[var(--border)] hover:bg-[var(--border-light)] disabled:opacity-50"
