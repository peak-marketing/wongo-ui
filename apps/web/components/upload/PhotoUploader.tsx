...
export default function PhotoUploader({
  ...
  return (
    <div className="space-y-4">
          ...
          {photos.map((photo) => {
            ...
            return (
              <div key={photo.id} className="relative group">
                ...
                <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2 p-2 text-xs text-white">
                ...
                {photo.error && (
                  <div className="absolute bottom-2 left-2 right-2 text-[11px] text-red-600 text-center">
                    {photo.error}
                  </div>
                )}
      ...
      {isDevMode && (
        <div className="text-xs rounded-md bg-[var(--bg)] border border-[var(--border)] p-2" style={{ color: 'var(--muted)' }}>
